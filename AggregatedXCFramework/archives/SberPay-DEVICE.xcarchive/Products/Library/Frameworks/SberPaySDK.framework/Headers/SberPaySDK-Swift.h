...
+ (void)getPaymentTokenWith:(SBPaymentTokenRequest * _Nonnull)paymentTokenRequest completion:(void (^ _Nonnull)(SBPaymentTokenResponse * _Nonnull))completion;
/// Метод для оплаты
+ (void)payWith:(SBPaymentRequest * _Nonnull)paymentRequest completion:(void (^ _Nonnull)(SBPError * _Nullable))completion;
/// Метод для завершения оплаты и закрытия окна SDK
+ (void)completePaymentWithPaymentSuccess:(BOOL)paymentSuccess completion:(SWIFT_NOESCAPE void (^ _Nonnull)(void))completion;
...
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey clientId:(NSString * _Nullable)clientId clientName:(NSString * _Nonnull)clientName amount:(NSInteger)amount currency:(NSString * _Nonnull)currency mobilePhone:(NSString * _Nullable)mobilePhone orderNumber:(NSString * _Nonnull)orderNumber orderDescription:(NSString * _Nullable)orderDescription language:(NSString * _Nullable)language recurrentEnabled:(BOOL)recurrentEnabled recurrentExipiry:(NSString * _Nullable)recurrentExipiry recurrentFrequency:(NSInteger)recurrentFrequency redirectUri:(NSString * _Nonnull)redirectUri OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey clientName:(NSString * _Nonnull)clientName amount:(NSInteger)amount currency:(NSString * _Nonnull)currency orderNumber:(NSString * _Nonnull)orderNumber recurrentEnabled:(BOOL)recurrentEnabled recurrentFrequency:(NSInteger)recurrentFrequency redirectUri:(NSString * _Nonnull)redirectUri;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
